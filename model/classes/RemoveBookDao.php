...
/**
 * This includes RemoveBookDaoInt.php file in this class.
 */
require_once("./model/Interfaces/RemoveBookDaoInt.php");

class RemoveBookDao implements RemoveBookDaoInt{
