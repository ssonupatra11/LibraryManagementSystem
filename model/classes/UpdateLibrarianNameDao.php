...
/**
 * This includes UpdateNameDaoInt.php file in this class.
 */
require_once("./model/Interfaces/UpdateNameDaoInt.php");

class UpdateLibrarianNameDao implements UpdateNameDaoInt{
            ...
            foreach($content as $val){
                ...
                if(strlen($val)>0){
                    ...
                    if($n[4]===$_SESSION['email']){
                        ...
                        fwrite($this->user_file,$new_name);
                        fwrite($this->user_file," ");
