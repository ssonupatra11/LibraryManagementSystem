...
/**
 * This includes BorrowBookDaoInt.php file in this class.
 */
require_once("./model/Interfaces/BorrowBookDaoInt.php");
...
class BorrowBookDao implements BorrowBookDaoInt{
     ...
     * @var string
     */
    private string $file_loc_1='./TextFiles/borrowedBooks.txt';
