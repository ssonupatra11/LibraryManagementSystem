...
/**
 * This includes UpdateBookNameDaoInt.php file in this class.
 */
require_once("./model/Interfaces/UpdateBookNameDaoInt.php");

class UpdateBookNameDao implements UpdateBookNameDaoInt{
            ...
            foreach($content as $val){
                ...
                if(strlen($val)>0){
                    ...
                    if($n[0]===$book_id){
                        ...
                        fwrite($this->book_file,$new_name);
                        fwrite($this->book_file," ");
