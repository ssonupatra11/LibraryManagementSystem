...
/**
 * This includes UpdateBookQtyDaoInt.php file in this class.
 */
require_once("./model/Interfaces/UpdateBookQtyDaoInt.php");

class UpdateBookQuantityDao implements UpdateBookQtyDaoInt{
